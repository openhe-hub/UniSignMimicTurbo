...
def get_args():
    ...
    # LCM Turbo parameters
    parser.add_argument(
        "--scheduler",
        type=str,
        choices=SCHEDULER_CHOICES,
        default="lcm",
        help="Noise scheduler for sampling (euler=30 steps, lcm=4-6 steps)",
    )
    parser.add_argument("--num_inference_steps", type=int, default=None,
                       help="Number of inference steps (default: 30 for euler, 6 for lcm)")
...
if __name__ == "__main__":
    ...
    with gr.Blocks() as demo:
        gr.Markdown("""<h1 align="center">Framer Turbo: Interactive Frame Interpolation with LCM</h1><br>""")

        gr.Markdown("""Gradio Demo for <a href='https://arxiv.org/abs/2410.18978'><b>Framer: Interactive Frame Interpolation</b></a> with LCM Acceleration.<br>
                    Github Repo can be found at https://github.com/aim-uofa/Framer<br>
                    <b>Turbo Mode: Using LCM scheduler for 5x faster inference (6 steps vs 30 steps)</b><br>
        ...
        gr.Markdown("""## Usage: <br>
                    ...
                    <br>
                    <b>Note: Turbo mode uses {} inference steps for faster generation.</b><br>""".format(args.num_inference_steps))
