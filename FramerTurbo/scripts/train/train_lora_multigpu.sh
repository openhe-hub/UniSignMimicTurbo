...
# FramerTurbo LoRA Fine-tuning Script - Multi-GPU with DeepSpeed
# Optimized for 4x A100/V100 GPUs with 576x576 resolution @ 10 frames
...
OUTPUT_DIR="outputs/lora_576x576_10f_4gpu"
...
GRADIENT_ACCUM=2          # Effective batch = 4 GPUs x 1 x 2 = 8
EPOCHS=30
LEARNING_RATE=1e-4
...
ACCELERATE_CONFIG="configs/accelerate_config_4gpu.yaml"
...
WANDB_PROJECT="framer-turbo-lora-10f-4gpu"
...
# Export DeepSpeed hostfile if needed (for multi-node)
