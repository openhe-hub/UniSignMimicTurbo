...
from app_turbo import Drag, get_args, configure_scheduler
...
def main():
    ...
    print(f"Framer Turbo CLI - Using {args.scheduler} scheduler with {args.num_inference_steps} steps")
...
# Usage examples:
#
# LCM mode (default, 6 steps):
# python cli_infer_turbo.py --input_dir assets/pairs --model checkpoints/framer_512x320/ --output_dir outputs
#
# LCM mode (aggressive, 4 steps):
# python cli_infer_turbo.py --input_dir assets/pairs --model checkpoints/framer_512x320/ --output_dir outputs --num_inference_steps 4
#
# Original Euler mode (30 steps):
# python cli_infer_turbo.py --input_dir assets/pairs --model checkpoints/framer_512x320/ --output_dir outputs --scheduler euler
